...
let spirits = [
    ...
    SpiritItem(spirit: Spirit(tier: .d, complexity: .low, name: "Lightning's Swift Strike", image: "Lightning's_Swift_Strike", aspectName: "Immense")),
    ...
    SpiritItem(spirit: Spirit(tier: .f, complexity: .low, name: "Shadows Flicker Like Flame", image: "Shadows_Flicker_Like_Flame", aspectName: "Amorphous")),
    SpiritItem(spirit: Spirit(tier: .d, complexity: .low, name: "Shadows Flicker Like Flame", image: "Shadows_Flicker_Like_Flame", aspectName: "Foreboding")),
    SpiritItem(spirit: Spirit(tier: .c, complexity: .low, name: "Vital Strength of the Earth", image: "Vital_Strength_of_the_Earth", aspectName: "Might")),
    ...
    SpiritItem(spirit: Spirit(tier: .a, complexity: .low, name: "Lightning's Swift Strike", image: "Lightning's_Swift_Strike", aspectName: "Sparking")),
    ...
    SpiritItem(spirit: Spirit(tier: .b, complexity: .low, name: "River Surges in Sunlight", image: "River_Surges_in_Sunlight", aspectName: "Haven")),
    SpiritItem(spirit: Spirit(tier: .c, complexity: .low, name: "Shadows Flicker Like Flame", image: "Shadows_Flicker_Like_Flame", aspectName: "Darkfire")),
    ...
    SpiritItem(spirit: Spirit(tier: .s, complexity: .low, name: "Vital Strength of the Earth", image: "Vital_Strength_of_the_Earth", aspectName: "Nourishing"))
